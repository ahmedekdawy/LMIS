...
{
    public class ObsceneWordsManager : IObsceneWordsManager
    {
        private static readonly IObsceneWordsRepository Repo = DalFactory.Singleton.ObsceneWords;
        public Infrastructure.Data.DTOs.ModelResponse Post(Infrastructure.Data.DTOs.UserInfo user, Infrastructure.Data.Entities.ObsceneWordsVm vm)
        {
            try
            {
                //Authorization
