...
{
    public class ConceptsDefinitionsManager : IConceptsDefinitionsManager
    {
        private static readonly IConceptsDefinitionsRepository Repo = DalFactory.Singleton.ConceptsDefinitions;
        public  ModelResponse Post(UserInfo user, ConceptsDefinitionsVM vm)
        {
            try
            {
                //Authorization
