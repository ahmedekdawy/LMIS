...
namespace LMIS.Bll.Managers
{
    ...
    {
        private static readonly IFaqRepository Repo = DalFactory.Singleton.Faq;
        public Infrastructure.Data.DTOs.ModelResponse Post(Infrastructure.Data.DTOs.UserInfo user, Infrastructure.Data.Entities.FaqVm vm)
        {
            try
            {
                //Authorization
        ...
        public Infrastructure.Data.DTOs.ModelResponse Get(int languageId, decimal? id)
        {
