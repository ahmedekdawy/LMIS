...
namespace LMIS.Portal.Helpers
{
    public sealed class BllFactory
    {
        ...
        private static readonly UserManager<ApplicationUser> UserMgr;
        ...
        public UserManager<ApplicationUser> User { get { return UserMgr; } }
        ...
        {
            //ASP.NET Identity
            UserMgr = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new ApplicationDbContext()));
