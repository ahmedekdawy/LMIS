<%@ Page Title="<%$ Resources:CommonControls, F018 %>" Language="C#" MasterPageFile="~/MasterPages/FrontEnd.Master" AutoEventWireup="true" CodeBehind="JobSearch.aspx.cs" Inherits="LMIS.Portal.LabourExchange.JobSearch" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    
    <script src="../Scripts/Extensions/lmis.js" async="async"></script>
    <script src="../LabourExchange/Scripts/JobSearch.js" async="async"></script>
                    ...
                    <td>
                        <div class="item row">
                            <div class="desc col-md-10 col-sm-10 col-xs-12">
                                <h3 class="title"><a href="#" target="_blank" data-bind="text: Title, attr: { href: $root.JobDetails(JobId) }"></a></h3>
                                <p data-bind="text: lmis.globalString.toLocal(Description, true)"></p>
                                <p><a class="more-link" href="#" target="_blank" data-bind="attr: { href: $root.JobDetails(JobId) }">
                                    <i class="fa fa-external-link"></i><%=GetGlobalResourceObject("CommonControls", "X_FindOutMore")%>
                                </a></p>
                            </div>
                        </div>
                    </td>
                    <td data-bind="text: EmploymentType"></td>
    ...
    <div class="col-lg-3">
        ...
        <hr />
            <div class="form-group">
                <label><%=GetGlobalResourceObject("CommonControls", "F018_EmploymentType")%></label>
                <select id="EmpType" class="form-control text-center bsmulti" multiple="multiple" data-bind="multiselect: lmis.defaults.multiselectNoFilterOptions, selectedOptions: EmploymentTypes, foreach: EmploymentTypeOptions">
