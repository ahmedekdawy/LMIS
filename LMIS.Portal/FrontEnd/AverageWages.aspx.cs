...
{
    public partial class AverageWages : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                var resultReport = BllFactory.Singleton.Reports.GetReports(ConfigurationManager.AppSettings["AverageWages"]);
