<%@ Page Title="<%$ Resources:CommonControls,F060 %>" Language="C#" MasterPageFile="~/MasterPages/FrontEnd.Master" AutoEventWireup="true" CodeBehind="TrainingProviders.aspx.cs" Inherits="LMIS.Portal.FrontEnd.TrainingProviders" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="../FrontEnd/Scripts/TrainingProviders.js"></script>
</asp:Content>
